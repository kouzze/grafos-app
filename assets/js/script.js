var data = {
	...
	links: [
		// { source: 0, target: 1, size: 2, title: '', data: {} },
		// { source: 1, target: 2, size: 4, title: '', data: {} },
		// { source: 0, target: 0, size: 2, title: '', data: {} },
		// { source: 2, target: 0, size: 2, title: '', data: {} }
	]
};
...
function ShowSelected() {
	var cod = document.getElementById("arista").value;
	if (cod === 'dirigida') {
		return options.directed = true
	} else {
		return options.directed = false
	}
}
